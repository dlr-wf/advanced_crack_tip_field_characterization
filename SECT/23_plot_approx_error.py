...
NODEMAP_NAME = 'Nodemap_F10000_alpha0.5_w100_h100_esize0.125.txt'
...
fit_results = os.path.join('williams_fitting', 'results', 'SECT_parameter_study_fit_method.csv')
...
plt.savefig(os.path.join(PLOT_PATH, f'SECT_{NODEMAP_NAME[:-4]}_{SIGMA}_norm_log.png'), dpi=600)
plt.close()
# plt.show()
