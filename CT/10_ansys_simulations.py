"""
    ...
    Simulations of CT-specimen with different parameters (force, alpha, width, esize).
...
for force, alpha, width, esize in track(list(itertools.product(FORCES, ALPHAS, WIDTHS, ESIZES))):
